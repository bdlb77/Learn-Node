...
function autocomplete(input, latInput, lngInput) {
  ...
  var dropdownList = new google.maps.places.Autocomplete(input);

  dropdownList.addListener('place_changed', function () {
    var place = dropdownList.getPlace();
...
function ajaxHeart(e) {
  ...
  _axios2.default.post(this.action).then(function (res) {
    // this.heart => sub element inside form tag this.heart = name="heart"
...
function makeMap(mapDiv) {
  ...
  loadPlaces(map);
  var input = (0, _bling.$)('input[name="geolocate"]');
...
function typeAhead(searchbox) {
  var searchInput = searchbox.querySelector('input[name="search"]');
  var searchResults = searchbox.querySelector('.search__results');
  ...
  searchInput.on('input', function () {
    ...
    _axios2.default.get('/api/v1/search?q=' + this.value).then(function (res) {
      if (res.data.length) {
        console.log('Showin something!');
        searchResults.innerHTML = _dompurify2.default.sanitize(resultsHTML(res.data));
        return;
      }
  ...
  searchInput.on('keyup', function (e) {
    ...
    var current = searchbox.querySelector('.' + activeClass);
    var items = searchbox.querySelectorAll('.search__result');
    var next = void 0;
